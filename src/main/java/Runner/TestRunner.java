...
@CucumberOptions(
features = "C:\\Users\\akshay.shete\\workspace\\AmazonBDDFramework\\src\\main\\java\\Features\\Tagging.feature", //path of feature file in Features tag
...
dryRun= true, //make it true :- to check for every step of scenario we hve defined stepDefaination or not and later make it false
monochrome = true, //make it true :- for readable console output
strict = false, //make it true :- It will failed execution if any stepDefination method is missing for the scenario steps
